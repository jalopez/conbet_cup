...
from conbet.prizes import WorldCupPrizes as Prizes
BETTING = True
MAX_GOALS = 10
BET = 5 # euros
...
DATABASE_NAME = 'conbet'       # Or path to database file if using sqlite3.
DATABASE_USER = 'conbet'       # Not used with sqlite3.
DATABASE_PASSWORD = 'conbet'   # Not used with sqlite3.
...
SECRET_KEY = '+9rabdjp0@@uwsn7m#)t=z2jd5boqq#29xffoxv6jdp$zcpz#b'
